package com.myMicroservice.hospitalManagement.HospitalManagement.generateSVG;
...
public class Main {
    ...
    public static void main(String[] args) throws TransformerException {
        ...
        for (Room roomFigure: roomList) {
            ...
            g.draw(rectangle);
            g.drawString(String.valueOf(roomFigure.getNumber_room()) , 0, 115);
            g.fill(rectangle);
            g.translate(110, 0);
...
//        g.setSVGCanvasSize(new Dimension(600, 600));
        ...
        Result output = new StreamResult(
                new File("/Users/iliu/IdeaProjects/HospitalManagement/src/main/java" +
                        "/com/myMicroservice/hospitalManagement/HospitalManagement/generateSVG/output.svg"));
